...
low_for_loop:
	...
	##Because decideCell takes in an int, i load either a 1 or 0 into $t3 depeding on the byte that i found in $t1(above instruction)
...
#I insert $t2(ret) into the newBoard directily in this function, rather than in the main function#
    la  $t0, newBoard
    mul $t1, $a2, $s4
    add $t1, $t1, $a3
    add $t3, $t0, $t1
